...
CREATE TABLE `car_bookings` (
  ...
  `keperluan` enum('Dinas','Proyek') NOT NULL,
  ...
  `expenditure_org` varchar(255) DEFAULT NULL,
  `status` enum('pending','accepted','ongoing','done','rejected') NOT NULL DEFAULT 'pending',
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `car_bookings_user_id_foreign` (`user_id`),
  CONSTRAINT `car_bookings_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `driver_assignments` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `car_booking_id` int(11) unsigned DEFAULT NULL,
  `driver_id` int(11) unsigned DEFAULT NULL,
  `mobil_jenis` varchar(100) DEFAULT NULL,
  `mobil_plat` varchar(20) DEFAULT NULL,
  `notes` text NOT NULL,
  `completed_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `car_booking_id` (`car_booking_id`),
...
CREATE TABLE `room_bookings` (
  ...
  `Procost` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `room_bookings_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL
...
CREATE TABLE `rooms` (
  ...
  `ruangrapat_url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2025-11-07  8:38:00
